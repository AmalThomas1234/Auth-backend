...
const changePassword = asyncHandler(async (req, res) => {
  ...
  if (user && passwordIsCorrect) {
    ...
    const subject = "Your Password Has Been Changed - AUTH:Z";
    const send_to = user.email;
    const sent_from = process.env.EMAIL_USER;
    const reply_to = "noreply@zino.com";
...
const loginWithCode = asyncHandler(async (req, res) => {
  ...
  if (loginCode !== decryptedLoginCode) {
    console.log(typeof loginCode, loginCode); // Log the type and value of loginCode
    console.log(typeof decryptedLoginCode, decryptedLoginCode); // Log the type and value of decryptedLoginCode
    res.status(400);
